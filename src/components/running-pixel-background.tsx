...
const RunningPixelBackground = () => {
  ...
  const getAnimationClass = () => {
    switch (theme) {
      case 'cyberpunk': return "animate-runner-glitch";
      case 'angelic': return "animate-angelic-flutter";
      case 'samurai': return "animate-samurai-sharp";
      default: return "";
    }
  };
