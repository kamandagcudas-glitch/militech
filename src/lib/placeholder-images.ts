...
export const PlaceHolderImages: ImagePlaceholder[] = [
    ...
    {
      "id": "coc2-step2",
      "description": "RJ45 connector and crimping tool used for network cabling.",
    ...
    {
      "id": "coc2-step4",
      "description": "Wireless router providing Wi-Fi and network access.",
    ...
    {
      "id": "coc4-step2",
      "description": "System restore and recovery tools on a workstation.",
    ...
    {
      "id": "coc4-step3",
      "description": "Disk maintenance and cleanup utilities dashboard.",
      ...
      "imageHint": "disk maintenance"
    },
    {
      "id": "coc4-step4",
      "description": "Antivirus scanning and security maintenance protocol.",
    ...
    },
    {
      ...
      "imageUrl": "https://images.unsplash.com/photo-1706954777655-7cb60eb69f51?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw4fHxydHglMjA0MDcwfGVufDB8fHx8MTc3MTM4NzYwNHww&ixlib=rb-4.1.0&q=80&w=1080",
