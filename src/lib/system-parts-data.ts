...
export const systemPartsData: SystemPart[] = [
  {
    ...
    position: { top: '40%', left: '40%', width: '45%', height: '50%' },
  },
  {
    id: 'cpu-cooler',
    ...
    position: { top: '35%', left: '38%', width: '15%', height: '15%' },
  },
  {
    id: 'ram',
    name: 'RAM (RGB Memory)',
    ...
    position: { top: '35%', left: '55%', width: '10%', height: '25%' },
  },
  {
    id: 'gpu',
    ...
    position: { top: '60%', left: '35%', width: '45%', height: '15%' },
  },
  {
    id: 'psu-shroud',
    ...
    position: { top: '85%', left: '40%', width: '60%', height: '12%' },
  },
  {
    id: 'case-fans',
    ...
    position: { top: '40%', left: '85%', width: '10%', height: '20%' },
  },
  {
    id: 'm2-ssd',
    name: 'NVMe M.2 SSD',
    ...
    position: { top: '52%', left: '52%', width: '5%', height: '5%' },
  },
  {
    id: 'cmos-battery',
    name: 'CMOS Battery',
    ...
    position: { top: '75%', left: '48%', width: '4%', height: '4%' },
  },
];
